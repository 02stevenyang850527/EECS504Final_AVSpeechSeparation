...
from keras.layers import Input, Dense, Convolution2D, MaxPooling2D, Deconvolution2D, multiply
...
############################
	...
	def build(cls, audio_spectrogram_shape, video_shape):
		...
		emb = encoder([audio_input, video_input])
		mask = decoder(emb)
		audio_output = multiply([mask, audio_input])
