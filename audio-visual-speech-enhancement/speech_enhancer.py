...
from utils.VideoNormalizer import *
from utils.reconstruct import *
# from  network_biLSTM import SpeechEnhancementNetwork
...
def predict(args):
	...
	for sample in samples:
		try:
			...
			#predicted_speech_signal /= np.max(abs(predicted_speech_signal))
